<template>
  <a class="flex lg:w-1/5 title-font font-medium items-center mb-4 md:mb-0">
    <svg class="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24">
      <title>atom-variant</title>
      <path
    ...
    <span class="ml-3 text-xl">Ow1.dev</span>
  </a>
</template>
